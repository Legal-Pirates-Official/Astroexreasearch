...
router.get("/admin/footer_contact", isloggedin, (req, res) => {
...
router.post("/admin/footer_contact/message", isloggedin, async (req, res) => {
...
router.get("/footer_contact/opt-out/:id", isloggedin, async (req, res) => {
    res.send(
